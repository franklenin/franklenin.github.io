...
---
It is alsmot 300 years that David Hume proposed the problem of induction on his celebrated *A Treatise of Human Nature*. Hume's thesis questions the validity of our inductive reasoning, As we know our inductive reasoning relies on past experiences to predict future events, e.g. my prediction that the sun will arise tomorrow. 

While my prediction is inocous, let's not forget that induction is one the key components in all our scientific entreprise. That is, induction is a central component when we formulate and build scientific theories. What Hume asesss is that we do not have any rational argument to relay in our inductive reasoning. While Hume is right, and beg to differ and propose that Bayesian statistics has a answer to the induction problem, and not only that. It has a beautifully formalism thay allows to mathematically quantify our degree of confidence in our predictions.
